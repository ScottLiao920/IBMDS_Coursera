...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={
        'textAlign': 'center', 'color': '#503D36', 'font-size': '24'}),#May include style for title
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'width':'80%', 'padding':'3','font-size':'24', 'textAlign':'center'}
        )
    ]),
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
        ...
        yearly_data = data[data['Year'] == input_year].reset_index()
